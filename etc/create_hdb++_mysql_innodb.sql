...
quality TINYINT(1) DEFAULT NULL,
att_error_desc_id INT UNSIGNED NULL DEFAULT NULL,
PRIMARY KEY(att_conf_id, data_time, idx)
...
PARTITION BY RANGE COLUMNS(data_time) (
	PARTITION p000 VALUES LESS THAN ('2015-01-01'),
        ...
        PARTITION p2018_01_02 VALUES LESS THAN ('2018-01-03'),
...
PARTITION BY RANGE COLUMNS(data_time) (
	PARTITION p000 VALUES LESS THAN ('2015-01-01'),
        ...
        PARTITION p2016_03 VALUES LESS THAN ('2016-04-01'),
        PARTITION p2016_04 VALUES LESS THAN ('2016-05-01'),
        PARTITION p2016_05 VALUES LESS THAN ('2016-06-01'),
        PARTITION p2016_06 VALUES LESS THAN ('2016-07-01'),
        PARTITION p2016_07 VALUES LESS THAN ('2016-08-01'),
        PARTITION p2016_08 VALUES LESS THAN ('2016-09-01'),
        PARTITION p2016_09 VALUES LESS THAN ('2016-10-01'),
        PARTITION p2016_10 VALUES LESS THAN ('2016-11-01'),
        PARTITION p2016_11 VALUES LESS THAN ('2016-12-01'),
        PARTITION p2016_12 VALUES LESS THAN ('2017-01-01'),
        PARTITION p2017_01 VALUES LESS THAN ('2017-02-01'),
        PARTITION p2017_02 VALUES LESS THAN ('2017-03-01'),
        PARTITION p2017_03 VALUES LESS THAN ('2017-04-01'),
        PARTITION p2017_04 VALUES LESS THAN ('2017-05-01'),
        PARTITION p2017_05 VALUES LESS THAN ('2017-06-01'),
        PARTITION p2017_06 VALUES LESS THAN ('2017-07-01'),
        PARTITION p2017_07 VALUES LESS THAN ('2017-08-01'),
        PARTITION p2017_08 VALUES LESS THAN ('2017-09-01'),
        PARTITION p2017_09 VALUES LESS THAN ('2017-10-01'),
        PARTITION p2017_10 VALUES LESS THAN ('2017-11-01'),
        PARTITION p2017_11 VALUES LESS THAN ('2017-12-01'),
